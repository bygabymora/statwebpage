                  ...
                  <tbody>
                    {cartItems.map((item) => (
                      <tr key={item._id} className="border-b">
                        <td>
                          <Link href={`/products/${item.manufacturer}-${item.name}-${item._id}`} className="flex items-center p-2">
                            <Image src={item.image} alt={item._id} width={50} height={50} className="rounded-lg" />
