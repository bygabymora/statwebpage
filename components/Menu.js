...
const Menu = () => {
  ...
  return (
    <nav className='bg-gray-50 backdrop-blur-sm shadow-sm border-b border-gray-200 w-full hidden md:block'>
      <ul className='flex justify-center space-x-1 text-[#0e355e] font-medium text-sm lg:text-base '>
        {updatedMenuItems.map((item, index) => (
          ...
          >
            ...
            {item.subcategories && item.subcategories?.length > 0 && (
              <div
                className={`custom-scrollbar absolute left-1/2 -translate-x-1/2 top-full mt-0.5 w-72 max-h-[22rem] overflow-y-auto 
                  ...
                  {item.subcategories.map((sub, subIndex) => (
                    <div key={subIndex}>
                      ...
                      <div className='px-4 pt-3 pb-1'>
                        <h4 className='text-[11px] font-semibold uppercase tracking-wider text-[#0e355e]/50'>
                          {sub.title}
                        </h4>
                      </div>
                        ...
                        {sub.links.map((link, linkIndex) => (
                          <li key={linkIndex}>
                            <Link
                              ...
                              className={`flex items-center gap-2.5 text-sm text-gray-600 px-3 py-1.5 rounded-lg transition-all duration-150 ${
